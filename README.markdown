## 「[通用 GitBook 範本](https://github.com/Vdragon/Generic_GitBook_Template)」內容未初始化說明<br />"[Generic GitBook Template](https://github.com/Vdragon/Generic_GitBook_Template)" content not-initialized note
